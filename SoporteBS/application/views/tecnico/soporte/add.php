    ...
    <section class="content">
      <?php  if ($equipos==False) { ?>
        <div class="callout callout-warning">
         <h4><p>No posee equipos Asignados!</p></h4><p>agregar equipo <a href="<?php echo base_url();?>tech/equipos/add">aqui</a> </p></div>
    <?php }  ?>
      ...
      <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <?php endif;?>                            
                   <form action="<?php echo base_url();?>tech/Soporte/new_orden" method="POST">
