...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
        Ordenes de Servicio
        <small>Detalles por Usuario</small>
        </h1>
    </section>
    <!-- Main content -->
       ...
       <div class="box-body table-responsive">                  
         <?php if (count($ordenes)): ?>
                        ...
                        <tbody>
                           <?php foreach ($ordenes as $item ):?>
                             <tr>
                              ...
                              <td>
                                <a type="button" name="button" value="<?=$item->orden;?>" class="btn btn-success btn-view-ordenes btn-sm" data-toggle="modal" data-target="#modal-default"><span class="fa fa-search"></span></a>
                              </td>
                            </tr>
                           <?php endforeach; ?>
                        </table>
                  ...
                  <div class="alert callout callout-danger" role="alert">
                    ...
                    <strong><i class="fa fa-warning fa-fw"></i>Disculpe!</strong><p> No Existen ordenes solicitadas por este ususario</p>
                  </div>
                    <?php endif; ?>
                 </div>
            </div>
