                            ...
                            <?php if(!empty($usuarios)):?>
                               <?php foreach($usuarios as $item):?>
                                   <tr>
                                       ...
                                       <td><?php echo $item->cod_dependencia;?></td>
                                       <td><?php echo $item->cod_tipo_usuario;?></td>
                                      <?php $datacliente = $item->ci_usuario."*".$item->nom_usuario."*".$item->ape_usuario."*".$item->correo_usuario."*".$item->cargo."*".$item->cod_dependencia."*".$item->cod_tipo_usuario;?>
                                       <td>
                                          <div class="btn-group">
                                              ...
                                              <a href="<?php echo base_url();?>reportes/usuarios/delete/<?=$item->ci_usuario;?>" class="btn btn-danger btn-remove-user btn-sm"><span class="fa fa-remove"></span></a>
                                           </div>
                                       </td>
                                   </tr>
                              <?php endforeach;?>
