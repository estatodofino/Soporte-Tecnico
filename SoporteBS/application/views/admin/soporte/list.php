                            ...
                            <td>
                               <div class="btn-group">
                                    <button type="button" class="btn btn-info btn-view-ordenes btn-sm" data-toggle="modal" data-target="#modal-default" value="<?php echo $orden->orden;?>">
                                     ...
                                     <a href="<?php echo base_url()?>admin/Soporte/asignar/<?=$orden->orden;?>" class="btn btn-warning btn-sm"><span class="fa fa-cogs"></span></a>

                                   <a href="<?php echo base_url();?>admin/soporte/delete_orden/<?=$orden->orden;?>" class="btn btn-danger btn-remove_orden btn-sm"><span class="fa fa-remove"></span></a>
                                </div>
                            </td>
                        </tr>
                   <?php endforeach;?>
