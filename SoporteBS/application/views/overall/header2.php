...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/proy/css/main.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/template/highcharts/Chart.js"">
    <!-- DataTables Export-->
...
<body class="hold-transition skin-blue-light sidebar-mini">
  <div class="main">
    <div class="logo1" >
      <!-- <img src="<?php echo base_url();?>assets/proy/images/2.jpg" style="width:100%;" alt=""> -->
    </div>
  </div>
    <!-- Site wrapper -->
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="<?php echo base_url();?>" class="logo">
                ...
                <span class="logo-lg"><b>ST</b></span>
            </a>
            ...
            <nav class="navbar navbar-static-top">
                ...
                <div class="navbar-custom-menu">
                    ...
                    <img src="<?php echo base_url()?>assets/template/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                        <span class="hidden-xs"><?php echo $this->session->userdata("nombre")?></span></a>
