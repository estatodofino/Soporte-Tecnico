...
class Orden extends CI_Controller {
   ...
   public function tipo()
   {
    ...
    $this->load->view('tecnico/reportes/ordenes/tipo', $data);
   ...
   public function dependencia()
   {
    if ($this->session->userdata("rol")==3) {
      ...
      $this->load->view('overall/header2');
      $this->load->view('overall/menuAdmin');
      $this->load->view('tecnico/reportes/ordenes/dep', $data);
      $this->load->view('overall/footer2');
    }elseif ($this->session->userdata("rol")==2) {
      $data = array(
       'dependencias' =>$this->Dependencias_model->get_all_dependencias()
        ...
        public function estatus()
   {
    if ($this->session->userdata("rol")==3) {
      $this->load->view('overall/header2');
      $this->load->view('overall/menuAdmin');
      $this->load->view('tecnico/reportes/ordenes/estatus'/*, $data*/);
      $this->load->view('overall/footer2');
      }elseif ($this->session->userdata("rol")==2) {
      $this->load->view('overall/header2');
      $this->load->view('overall/menuTecnico');
      ...
      public function usuarios()
   {
    if ($this->session->userdata("rol")==3) {
      ...
      $this->load->view('overall/header2');
      $this->load->view('overall/menuAdmin');
      $this->load->view('tecnico/reportes/ordenes/usuarios', $data);
      $this->load->view('overall/footer2');
    }elseif ($this->session->userdata("rol")==2) {
      $data = array(
         'usuarios' => $this->Usuarios_model->getUsuarios()
   ...
   public function ver_by_users($id)
   {
    if ($this->session->userdata("rol")==3) {
      ...
      $this->load->view('overall/header2');
      $this->load->view('overall/menuAdmin');
      $this->load->view('tecnico/reportes/ordenes/list_usuario', $data);
      $this->load->view('overall/footer2');
    }elseif ($this->session->userdata("rol")==2) {
   ...
   public function ver_tipo($id)
  {
   ...
   $this->load->view('overall/header2');
   $this->load->view('overall/menuAdmin');
   $this->load->view('tecnico/reportes/ordenes/list_tipo', $data);
   $this->load->view('overall/footer2');
  }elseif ($this->session->userdata("rol")==2) {
   $data = array(
     'ordenes' =>$this->Ordenes_model->get_orden_by_tipo($id)
      ...
      public function ver_estatus($id)
   {
    if ($this->session->userdata("rol")==3) {
      ...
      $this->load->view('overall/header2');
      $this->load->view('overall/menuAdmin');
      $this->load->view('tecnico/reportes/ordenes/list_estado', $data);
      $this->load->view('overall/footer2');
    }elseif ($this->session->userdata("rol")==2) {
      $data = array(
         'ordenes' =>$this->Ordenes_model->get_orden_by_estado($id)
   ...
   $this->load->view("overall/header2");
   $this->load->view("overall/menuTecnico");
   $this->load->view("tecnico/reportes/ordenes/list",$data);//misma vista donde se busca la info
   $this->load->view("overall/footer2");
 }
  ...
  public function tecnico()
  {
    ...
    $this->load->view("overall/header2");
    $this->load->view("overall/menuTecnico");
    $this->load->view("tecnico/reportes/ordenes/tecnico",$data);//misma vista donde se busca la info
    $this->load->view("overall/footer2");
  }
  public function ver_dependencias($id)
  {
    if ($this->session->userdata("rol")==3) {      
     $data = array(
        'ordenes' =>$this->Ordenes_model->get_orden_by_dependencia($id)
          );
     $this->load->view('overall/header2');
     $this->load->view('overall/menuAdmin');
     $this->load->view('tecnico/reportes/ordenes/list_dependencias', $data);
     $this->load->view('overall/footer2');
    }elseif ($this->session->userdata("rol")==2) {
